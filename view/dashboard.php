...
<div id="sia">
    <div class="content">
        ...
        <div class="itu">
            ...
            <canvas id="canvas" height="400" width="1130"></canvas>
            <script>
                var barChartData = {
                    labels : [<?php
                    ...
                    datasets : [
                        {
                            ...
                            data : [<?php
                                ...
                                for ($i=1;$i<=12;$i++){
                                    $dd = sprintf("%02d", $i);
                                    $d = $th.'-'.$dd;
                                    $a=mysqli_query($conn,"SELECT count(idpenghuni) as jml FROM narapidana WHERE substr(tglmasuk,1,7)='$d'");
                                    $b=mysqli_fetch_array($a);
                                    echo $b['jml'].',';
                                }
                                ?>],
    ...
    <div class="content">
        ...
        <div class="itu">
            ...
            <table class="table table-striped table-bordered data">
                ...
                while ($a =mysqli_fetch_array($sql)) {
                    $as=TanggalIndoAngko($a['tglmasuk']);
